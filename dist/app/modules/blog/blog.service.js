...
// create a new blog
const createBlog = (profileId, payload) =>
...
const getBlogBySlug = slug =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const blogReturn = Object.assign(Object.assign({}, result), {
      nextBlog:
        nextBlog === null || nextBlog === void 0 ? void 0 : nextBlog.slug,
      previousBlog:
        previousBlog === null || previousBlog === void 0
          ? void 0
          : previousBlog.slug,
    })
...
// all blogs
const getAllBlogs = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
