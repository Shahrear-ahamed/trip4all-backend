...
router.post('/', (0, auth_1.default)(userRole_1.ENUM_USER_ROLE.SUPER_ADMIN, userRole_1.ENUM_USER_ROLE.ADMIN), (0, validateRequest_1.default)(blog_validation_1.BlogValidation.createBlogZodSchema), blog_controller_1.BlogController.createBlog);
...
router.delete('/:id', (0, auth_1.default)(userRole_1.ENUM_USER_ROLE.SUPER_ADMIN, userRole_1.ENUM_USER_ROLE.ADMIN), blog_controller_1.BlogController.deleteBlog);
