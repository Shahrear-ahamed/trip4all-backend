...
const createReview = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield review_service_1.ReviewService.createReview(id, payload);
...
const getMyReviews = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const result = yield review_service_1.ReviewService.getMyReviews((_a = req === null || req === void 0 ? void 0 : req.user) === null || _a === void 0 ? void 0 : _a.id);
    // send response after create review
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
