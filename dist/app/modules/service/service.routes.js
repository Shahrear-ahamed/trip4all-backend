...
router.get(
  '/home/:status',
  service_controller_1.ServiceController.getServiceByStatus,
)
...
router.post(
  ...
  (0, validateRequest_1.default)(
    service_validation_1.ServiceValidation.createServiceZodSchema,
  ),
...
router.patch(
  ...
  (0, auth_1.default)(userRole_1.ENUM_USER_ROLE.ADMIN),
  (0, validateRequest_1.default)(
    service_validation_1.ServiceValidation.updateServiceZodSchema,
  ),
