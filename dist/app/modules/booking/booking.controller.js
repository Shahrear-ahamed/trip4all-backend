...
const getAllBookings = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield booking_service_1.BookingService.getAllBookings(paginationOptions)
    // send response
    ;(0, sendResponse_1.default)(res, {
      success: true,
...
const getAllBookingsByStatus = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield booking_service_1.BookingService.getAllBookingsByStatus(
        status,
        paginationOptions,
      )
    // send response
