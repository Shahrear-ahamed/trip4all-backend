...
// create new booking
const createBooking = (profileId, bookingData) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllBookingsByStatus = (status, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
...
const myBookings = (profileId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.booking.findMany({
        where: {
            profileId,
        },
