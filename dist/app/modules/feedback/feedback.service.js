...
// get all feedbacks
const getAllFeedbacks = (paginationOptions, dateRange) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (dateRange && dateRange.startDate && dateRange.endDate) {
        whereCondition = Object.assign(Object.assign({}, whereCondition), { createdAt: {
                gte: luxon_1.DateTime.fromJSDate(dateRange.startDate).startOf('day').toISO(),
                lte: luxon_1.DateTime.fromJSDate(dateRange.endDate).endOf('day').toISO(),
            } });
    }
    ...
    const total = yield prisma_1.default.feedback.count({ where: whereCondition });
