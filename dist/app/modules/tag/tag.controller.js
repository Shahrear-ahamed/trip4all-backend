...
// create tag
const createTag = (0, catchAsync_1.default)((req, res) =>
...
// get single tag
const getATag = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
// update tag
const updateTag = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id
    const body = req.body
...
// delete tag
const deleteTag = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id
