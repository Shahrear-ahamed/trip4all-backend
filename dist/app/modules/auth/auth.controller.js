...
const signUp = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, sendResponse_1.default)(res, {
        ...
        message: 'Register successfully, we send you an email to verify your account',
        data: result,
    });
}));
...
const signIn = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = req.body;
    const _a = yield auth_service_1.AuthService.signIn(body), { refreshToken } = _a, result = __rest(_a, ["refreshToken"]);
...
const changePassword = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield auth_service_1.AuthService.changePassword(profileId, body);
    // send response
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
