...
const signUp = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction(createAccountTrans =>
      __awaiter(void 0, void 0, void 0, function* () {
        // create profile
...
const signIn = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // now check password
    const isMatch = yield bcryptPass_1.BcryptPassword.comparePassword(
      password,
      result.password,
    )
    ...
    const refreshToken =
      yield token_1.TokenServices.generateRefreshToken(tokenPayload)
...
const getAccessToken = token =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield token_1.TokenServices.verifyToken(
      token,
...
const changePassword = (profileId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // hash new password
    const hashPass =
      yield bcryptPass_1.BcryptPassword.hashedPassword(newPassword)
    // update password
